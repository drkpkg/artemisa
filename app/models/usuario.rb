...
class Usuario < ActiveRecord::Base
  ...
  validates_presence_of :nombre_usuario, :email, :clave, message: " Campos en blanco "
  ...
  validates :clave, length: {in: 4..20, message: " La contraseña tiene que tener más de 4 caracteres "}
