...
#Admin
Usuario.create(username: "admin", password_digest: BCrypt::Password.create("123456"), email: "admin@admin.com" , group_id: 1, state: true)
Usuario.create(username: "client", password_digest: BCrypt::Password.create("123456"), email: "client@gmail.com" , group_id: 2, state: true)
Usuario.create(username: "employee", password_digest: BCrypt::Password.create("123456"), email: "employee@gmail.com" , group_id: 3, state: true)
